...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 28 nov. 2024 à 10:43
...
(8, 'AHAD', 'TEST', '12 RUE DE LA PARIS', 'PARIS', '75000', 'OK', 9, '1');
...
(7, 'v.faye@lprs.fr', 'a641e63f7b19c07d', '$2y$10$fw7jB/zFlTNj9.l52JkpceLhRgvDvI5ieEhw8xcNpelvgR5yU1aki', '1732117629');
...
(7, 'TEST', 'TEST', 'TEST', '01/01/2000', 1000, 'CDI');
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `email`, `password`, `fonction`, `cv`, `spécialité`, `ref_hopital`, `inscrit`) VALUES
(18, 's', 's', 's@s.fr', 's', 'professeur', NULL, 'Infirmier', 1, 1),
(22, 'FAYE', 'Victor', 'v.faye@lprs.fr', '$2y$10$GsQVTcZaCRZlW5/6tNwaVedFV1M1hzUS8dvoj.37A2Q9tmQqwoIym', 'eleve', 'CV.pdf', NULL, NULL, 1);
