            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
                    ...
                    <div class="featured-image mb-3">
                        <img src="/HSP/assets/img/rb_37291.png" class="img-fluid"
                             style="width: 200px; align-content: center" alt="">
                    </div>
                    <p class="text-white fs-2" style=" font-weight: 600;">Partager vos idées</p>
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        ...
                        <form method="post" action="/HSP/src/controller/traitPost.php"
                            ...
                            <div class="input-group mb-3">
                                <select name="categorie" class="form-control form-control-lg bg-light fs-6 " required>
                            ...
                            <div class="input-group mb-3">
                                <textarea name="description" class="form-control form-control-lg bg-light fs-6"  placeholder="Description"></textarea>
                            </div>
                            <div class="input-group mb-3">
                        ...
                        <div class="row">
                            <small>Retour au forum ?  <a
                                        href="/HSP/vue/forum/newForum.php?choix=">Par ici</a>
                            </small>
                        </div>
                    </div>
                </div>
