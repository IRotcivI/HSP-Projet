...
<main style="background: url('assets/img/imghopital.jpg');">
            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #4A90E2;">
                    <div class="featured-image mb-3">
                        <img src="../../assets/img/rb_2147795907.png" class="img-fluid" style="width: 250px;" alt="">
                    </div>
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        <form method="post" action="../../src/controller/traitConnexion.php">
                            ...
                            <div class="input-group mb-5 d-flex justify-content-between">
                                <small>Pas de compte ? <a href="../../index.php">Inscrivez-vous</a></small>
                            </div>
                        </form>
                        <div class="faute">
                            <?php
