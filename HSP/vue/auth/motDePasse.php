        ...
        <div class="container d-flex justify-content-center align-items-center min-vh-100">
            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
                    ...
                    <small class="text-white text-wrap text-center" style="width: 17rem;">Un e-mail vous sera envoyé
                        avec un lien pour changer votre mot de passe.</small>
                </div>
                <!-------------------- ------ Right Box ---------------------------->
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        <form method="post" action="../../src/controller/traitMotDePasse.php">
                            ...
                            <div class="input-group mb-3">
                                <button type="submit" name="submit" class="btn btn-lg btn-primary w-100 fs-6">Envoyer
                                </button>
                            </div>
