            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
                    ...
                    <div class="featured-image mb-3">
                        <img src="../../../assets/img/writer-svgrepo-com.svg" class="img-fluid"
                    ...
                    <div class="row align-items-center">
                        ...
                        <form method="post" action="../../../src/controller/traitInscription.php"
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="formation"
                                       class="form-control form-control-lg bg-light fs-6" placeholder="Formation">
                            </div>
                            <div class="input-group mb-3">
                                <label for="pdfUpload" class="form-label text-secondary w-100"><small>Ajouter un
                                        document PDF (ex : CV)</small></label>
                                <input type="file" name="file" id="pdfUpload"
                                       class="form-control form-control-lg bg-light fs-6" accept=".pdf" required>
                            </div>
                            <div class="input-group mb-3">
                        ...
                        <div class="row">
                            <small>Déjà un compte ? <a
                                        href="../../../vue/auth/formLogin.php">Connectez-vous</a>
                            </small>
                        </div>
                    </div>
                </div>
