...
if (empty($_SESSION)) {
    ...
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/eleveOffre.css">
    </head>
    <body>
            ...
            foreach ($aff as $ligne) {
                ...
                <tr>
                    <form action="/HSP/src/controller/traitEleveOffre.php" method="POST">
                        ...
                        <td>
                            <p class="fw-normal mb-1"><?php echo htmlspecialchars($ligne['tache'])?></p>
                        </td>
                        <td>
                            <p class="fw-normal mb-1"><?php echo htmlspecialchars($ligne['date']) ?></p>
                        </td>
                        <td>
                            <p class="fw-normal mb-1"><?php echo htmlspecialchars($ligne['salaire'])?></p>
                        </td>
                        <td>
                            <p class="fw-normal mb-1"><?php echo htmlspecialchars($ligne['type'])?></p>
                        </td>
                        <td>
                            <?php
                            ...
                            if ($resultat) { ?>
                                ...
                                <button type="submit" name="submit" value="postuler" class="btn btn-success" data-mdb-ripple-init>Candidater</button>
                                <?php
                            }
                            ?>
                            </td>
