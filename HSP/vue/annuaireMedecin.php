                ...
                <ul class="navbar-nav flex-row">
                    ...
                    <li class="nav-item me-3 me-lg-1">
                        <a class="nav-link d-sm-flex align-items-sm-center" href="auth/profiles.php">
                            <img src="https://mdbcdn.b-cdn.net/img/new/avatars/1.webp" class="rounded-circle" height="22" alt="Portrait en noir et blanc d'un homme" loading="lazy" />
        ...
        <table id="myTable" class="table align-middle mb-0 bg-white display">
            ...
            foreach ($aff as $ligne) {
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-success rounded-pill d-inline">Eleve</span>
                    </td>
                    <td>
                        <select class="form-select">
                            <option value="cardiologue" <?php if ($ligne['metier'] == 'cardiologue') echo 'selected'; ?>>Cardiologue</option>
                            <option value="neurologue" <?php if ($ligne['metier'] == 'neurologue') echo 'selected'; ?>>Neurologue</option>
                            <option value="gastroenterologue" <?php if ($ligne['metier'] == 'gastroenterologue') echo 'selected'; ?>>Gastroentérologue</option>
                        </select>
                    </td>
                </tr>
                <?php
