...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 14 oct. 2024 à 14:42
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `entreprise` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'FAYE', 'Victor', 'v.faye@lprs.fr', '$2y$10$LNfYBJnjbu58LKQFIBiFM.aoMDYlWeanY12wMHLAMwYlfYMw7wbZW', 'eleve', NULL, NULL, NULL, NULL, NULL);
